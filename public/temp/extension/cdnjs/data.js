...
(function(p) { "object" === typeof module && module.exports ? module.exports = p : p(Highcharts) })(function(p) {
    (function(g) {
        ...
        g.extend(u.prototype, {
            ...
            dateFormats: {
                "YYYY-mm-dd": { regex: /^([0-9]{4})[\-\/\.]([0-9]{2})[\-\/\.]([0-9]{2})$/, parser: function(b) { return Date.UTC(+b[1], b[2] - 1, +b[3]) } },
                ...
                "dd/mm/YY": {
                    ...
                    parser: function(b) { return Date.UTC(+b[3] + 2E3, b[2] - 1, +b[1]) },
        ...
        n.prototype.populateColumns = function(b) {
            ...
            m(this.readers, function(b) { void 0 === b.columnIndex && (a = !1) });
            return a
        };
