(function() {
    ...
    function ca(a, b, c) { a instanceof String && (a = String(a)); for (var d = a.length, e = 0; e < d; e++) { var g = a[e]; if (b.call(c, g, e, a)) return { U: e, Z: g } } return { U: -1, Z: void 0 } }
    ...
    r("Array.prototype.find", function(a) { return a ? a : function(b, c) { return ca(this, b, c).Z } });
    ...
    r("String.prototype.trimStart", function(a) { return a || String.prototype.trimLeft });
    r("Promise", function(a) {
        ...
        b.prototype.l = function() {
            function f(m) { return function(p) { k || (k = !0, m.call(h, p)) } }
            var h = this,
                k = !1;
        ...
        b.prototype.J = function(f) { var h = void 0; try { h = f.then } catch (k) { this.m(k); return } "function" == typeof h ? this.aa(h, f) : this.o(f) };
        ...
        b.prototype.M = function() {
            var f = this;
            e(function() { if (f.G()) { var h = q.console; "undefined" !== typeof h && h.error(f.i) } }, 1)
        };
        b.prototype.G =
            function() {
                if (this.s) return !1;
                ...
                "function" === typeof f ? f = new f("unhandledrejection", { cancelable: !0 }) : "function" === typeof h ? f = new h("unhandledrejection", { cancelable: !0 }) : (f = q.document.createEvent("CustomEvent"), f.initCustomEvent("unhandledrejection", !1, !0, f));
                f.promise = this;
                f.reason = this.i;
                return k(f)
            };
        ...
        b.prototype.aa = function(f, h) { var k = this.l(); try { f.call(h, k.resolve, k.reject) } catch (m) { k.reject(m) } };
        b.prototype.then = function(f, h) {
            function k(B, J) { return "function" == typeof B ? function(va) { try { m(B(va)) } catch (wa) { p(wa) } } : J }
        ...
        b.race = function(f) { return new b(function(h, k) { for (var m = n(f), p = m.next(); !p.done; p = m.next()) d(p.value).L(h, k) }) };
        b.all = function(f) {
            var h = n(f),
                k = h.next();
    ...
    r("String.prototype.includes", function(a) { return a ? a : function(b, c) { return -1 !== t(this, b, "includes").indexOf(b, c || 0) } });
    ...
    r("Symbol.iterator", function(a) {
        ...
        for (var b = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c = 0; c < b.length; c++) { var d = q[b[c]]; "function" === typeof d && "function" != typeof d.prototype[a] && da(d.prototype, a, { configurable: !0, writable: !0, value: function() { return fa(aa(this)) } }) }
        return a
    });
    r("Symbol.asyncIterator", function(a) { return a ? a : Symbol("Symbol.asyncIterator") });
    ...
    r("Array.prototype.findIndex", function(a) { return a ? a : function(b, c) { return ca(this, b, c).U } });
    ...
    r("Array.of", function(a) { return a ? a : function(b) { return Array.from(arguments) } });
    ...
    var ma = ia;
    r("globalThis", function(a) { return a || q });

    function u(a, b) { return Object.prototype.hasOwnProperty.call(a, b) }
    r("WeakMap", function(a) {
        function b(k) { this.g = (h += Math.random() + 1).toString(); if (k) { k = n(k); for (var m; !(m = k.next()).done;) m = m.value, this.set(m[0], m[1]) } }
    ...
    r("Map", function(a) {
        function b() { var h = {}; return h.B = h.next = h.head = h }
        ...
        function d(h, k) {
            ...
            var p = h.h[m];
            if (p && u(h.h, m))
                for (h = 0; h < p.length; h++) { var x = p[h]; if (k !== k && x.key !== x.key || k === x.key) return { id: m, list: p, index: h, u: x } }
            return {
                id: m,
                list: p,
                index: -1,
    ...
    r("Math.acosh", function(a) { return a ? a : function(b) { b = Number(b); return Math.log(b + Math.sqrt(b * b - 1)) } });
    r("Math.asinh", function(a) { return a ? a : function(b) { b = Number(b); if (0 === b) return b; var c = Math.log(Math.abs(b) + Math.sqrt(b * b + 1)); return 0 > b ? -c : c } });
    r("Math.log1p", function(a) { return a ? a : function(b) { b = Number(b); if (.25 > b && -.25 < b) { for (var c = b, d = 1, e = b, g = 0, f = 1; g != e;) c *= b, f *= -1, e = (g = e) + f * c / ++d; return e } return Math.log(1 + b) } });
    r("Math.atanh", function(a) { if (a) return a; var b = Math.log1p; return function(c) { c = Number(c); return (b(c) - b(-c)) / 2 } });
    ...
    r("Math.cosh", function(a) { if (a) return a; var b = Math.exp; return function(c) { c = Number(c); return (b(c) + b(-c)) / 2 } });
    r("Math.expm1", function(a) { return a ? a : function(b) { b = Number(b); if (.25 > b && -.25 < b) { for (var c = b, d = 1, e = b, g = 0; g != e;) c *= b / ++d, e = (g = e) + c; return e } return Math.exp(b) - 1 } });
    r("Math.fround", function(a) { if (a) return a; if ("function" !== typeof Float32Array) return function(c) { return c }; var b = new Float32Array(1); return function(c) { b[0] = c; return b[0] } });
    ...
    r("Math.log10", function(a) { return a ? a : function(b) { return Math.log(b) / Math.LN10 } });
    r("Math.log2", function(a) { return a ? a : function(b) { return Math.log(b) / Math.LN2 } });
    r("Math.sign", function(a) { return a ? a : function(b) { b = Number(b); return 0 === b || isNaN(b) ? b : 0 < b ? 1 : -1 } });
    r("Math.sinh", function(a) { if (a) return a; var b = Math.exp; return function(c) { c = Number(c); return 0 === c ? c : (b(c) - b(-c)) / 2 } });
    ...
    r("Math.trunc", function(a) { return a ? a : function(b) { b = Number(b); if (isNaN(b) || Infinity === b || -Infinity === b || 0 === b) return b; var c = Math.floor(Math.abs(b)); return 0 > b ? -c : c } });
    r("Number.EPSILON", function() { return Math.pow(2, -52) });
    r("Number.MAX_SAFE_INTEGER", function() { return 9007199254740991 });
    r("Number.MIN_SAFE_INTEGER", function() { return -9007199254740991 });
    ...
    r("Number.parseFloat", function(a) { return a || parseFloat });
    r("Number.parseInt", function(a) { return a || parseInt });
    ...
    r("Object.assign", function(a) { return a || na });
    ...
    r("Object.getOwnPropertySymbols", function(a) { return a ? a : function() { return [] } });
    ...
    r("Object.getOwnPropertyDescriptors", function(a) { return a ? a : function(b) { for (var c = {}, d = Reflect.ownKeys(b), e = 0; e < d.length; e++) c[d[e]] = Object.getOwnPropertyDescriptor(b, d[e]); return c } });
    ...
    r("Reflect.apply", function(a) { if (a) return a; var b = Function.prototype.apply; return function(c, d, e) { return b.call(c, d, e) } });
    ...
    r("Reflect.construct", function() { return pa });
    r("Reflect.defineProperty", function(a) { return a ? a : function(b, c, d) { try { Object.defineProperty(b, c, d); var e = Object.getOwnPropertyDescriptor(b, c); return e ? e.configurable === (d.configurable || !1) && e.enumerable === (d.enumerable || !1) && ("value" in e ? e.value === d.value && e.writable === (d.writable || !1) : e.get === d.get && e.set === d.set) : !1 } catch (g) { return !1 } } });
    r("Reflect.deleteProperty", function(a) { return a ? a : function(b, c) { if (!u(b, c)) return !0; try { return delete b[c] } catch (d) { return !1 } } });
    r("Reflect.getOwnPropertyDescriptor", function(a) { return a || Object.getOwnPropertyDescriptor });
    r("Reflect.getPrototypeOf", function(a) { return a || Object.getPrototypeOf });
    ...
    r("Reflect.get", function(a) { return a ? a : function(b, c, d) { if (2 >= arguments.length) return b[c]; var e = qa(b, c); if (e) return e.get ? e.get.call(d) : e.value } });
    r("Reflect.has", function(a) { return a ? a : function(b, c) { return c in b } });
    r("Reflect.isExtensible", function(a) { return a ? a : "function" == typeof Object.isExtensible ? Object.isExtensible : function() { return !0 } });
    r("Reflect.preventExtensions", function(a) { return a ? a : "function" != typeof Object.preventExtensions ? function() { return !1 } : function(b) { Object.preventExtensions(b); return !Object.isExtensible(b) } });
    r("Reflect.set", function(a) { return a ? a : function(b, c, d, e) { var g = qa(b, c); return g ? g.set ? (g.set.call(3 < arguments.length ? e : b, d), !0) : g.writable && !Object.isFrozen(b) ? (b[c] = d, !0) : !1 : Reflect.isExtensible(b) ? (b[c] = d, !0) : !1 } });
    ...
    r("String.prototype.padEnd", function(a) { return a ? a : function(b, c) { var d = t(this, null, "padStart"); return d + ra(c, b - d.length) } });
    r("String.prototype.padStart", function(a) { return a ? a : function(b, c) { var d = t(this, null, "padStart"); return ra(c, b - d.length) + d } });
    r("String.prototype.trimRight", function(a) {
        function b() { return this.replace(/[\s\xa0]+$/, "") }
        return a || b
    });
    r("String.prototype.trimEnd", function(a) { return a || String.prototype.trimRight });

    function v(a) { return a ? a : Array.prototype.copyWithin }
    ...
    function w(a) { return a ? a : Array.prototype.fill }
    ...
    r("WeakSet", function(a) {
        function b(c) { this.g = new WeakMap; if (c) { c = n(c); for (var d; !(d = c.next()).done;) this.add(d.value) } }
        if (function() {
                if (!a || !Object.seal) return !1;
                try {
                    var c = Object.seal({}),
    ...
    function ua(a) { return (a = a.querySelector && a.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && sa.test(a) ? a : "" }
    ...
    function C(a, b, c) { Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? C = ya : C = za; return C.apply(null, arguments) }
    ...
    function E(a, b) {
        ...
        a.qa = function(d, e, g) { for (var f = Array(arguments.length - 2), h = 2; h < arguments.length; h++) f[h - 2] = arguments[h]; return b.prototype[e].apply(d, f) }
    }
    ...
    G.prototype.V = !0;
    G.prototype.T = function() { return this.g };

    function Da(a) { return a instanceof G && a.constructor === G && a.h === Ca ? a.g : "type_error:Const" }

    function H(a) { return new G(Ba, a) }
    var Ca = {},
        Ba = {};
    var I = { j: {} };
    I.j.O = {
        ...
        Oa: { d3: { subdir1: "d3", subdir2: "v5", filename: "d3.js" }, "d3.sankey": { subdir1: "d3_sankey", subdir2: "v4", filename: "d3.sankey.js" }, webfontloader: { subdir: "webfontloader", filename: "webfont.js" } },
    ...
    var Ea = Array.prototype.forEach ? function(a, b, c) { Array.prototype.forEach.call(a, b, c) } : function(a, b, c) { for (var d = a.length, e = "string" === typeof a ? a.split("") : a, g = 0; g < d; g++) g in e && b.call(c, e[g], g, a) },
        Fa = Array.prototype.map ? function(a, b) { return Array.prototype.map.call(a, b, void 0) } : function(a, b) { for (var c = a.length, d = Array(c), e = "string" === typeof a ? a.split("") : a, g = 0; g < c; g++) g in e && (d[g] = b.call(void 0, e[g], g, a)); return d },
        Ga = Array.prototype.some ? function(a, b) { return Array.prototype.some.call(a, b, void 0) } :
        function(a, b) {
    ...
    function Ha(a) { return Array.prototype.concat.apply([], arguments) }
    ...
    function K(a, b) { this.g = b === Ka ? a : "" }
    K.prototype.V = !0;
    K.prototype.T = function() { return this.g.toString() };
    K.prototype.toString = function() { return this.g + "" };

    function La(a) { return a instanceof K && a.constructor === K ? a.g : "type_error:TrustedResourceUrl" }
    ...
    function Pa(a) {
        if (void 0 === Ja) {
            ...
            if (c && c.createPolicy) {
                try { b = c.createPolicy("goog#html", { createHTML: Aa, createScript: Aa, createScriptURL: Aa }) } catch (d) { y.console && y.console.error(d.message) }
                Ja = b
            } else Ja = b
        }
    ...
    a: {
        var Va = y.navigator;
        if (Va) { var Wa = Va.userAgent; if (Wa) { L = Wa; break a } }
        L = ""
    }
    ...
    function Za(a, b) { for (var c, d, e = 1; e < arguments.length; e++) { d = arguments[e]; for (c in d) a[c] = d[c]; for (var g = 0; g < Ya.length; g++) c = Ya[g], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c]) } };
    ...
    function ab(a) { var b = bb; return Object.prototype.hasOwnProperty.call(b, 11) ? b[11] : b[11] = a(11) };
    var cb = M("Opera"),
        db = M("Trident") || M("MSIE"),
        eb = M("Edge"),
    ...
    a: {
        var ib = "",
            jb = function() { var a = L; if (fb) return /rv:([^\);]+)(\)|;)/.exec(a); if (eb) return /Edge\/([\d\.]+)/.exec(a); if (db) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (gb) return /WebKit\/(\S+)/.exec(a); if (cb) return /(?:Version)[ \/]?(\S+)/.exec(a) }();jb && (ib = jb ? jb[1] : "");
        if (db) {
            var kb, lb = y.document;
            kb = lb ? lb.documentMode : void 0;
            if (null != kb && kb > parseFloat(ib)) { hb = String(kb); break a }
        }
        hb = ib
    }
    var mb = hb,
    ...
    function ob(a, b) { Xa(b, function(c, d) { c && "object" == typeof c && c.V && (c = c.T()); "style" == d ? a.style.cssText = c : "class" == d ? a.className = c : "for" == d ? a.htmlFor = c : pb.hasOwnProperty(d) ? a.setAttribute(pb[d], c) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, c) : a[d] = c }) }
    var pb = { cellpadding: "cellPadding", cellspacing: "cellSpacing", colspan: "colSpan", frameborder: "frameBorder", height: "height", maxlength: "maxLength", nonce: "nonce", role: "role", rowspan: "rowSpan", type: "type", usemap: "useMap", valign: "vAlign", width: "width" };
    ...
    function ub() {
        ...
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !M("Presto") && (a = function() {
            ...
            e = C(function(k) { if (("*" == h || k.origin == h) && k.data == f) this.port1.onmessage() }, this);
        ...
        return function(e) { y.setTimeout(e, 0) }
    };

    function vb(a) { y.setTimeout(function() { throw a; }, 0) };

    function wb() { this.h = this.g = null }
    ...
    var xb = new rb(function() { return new Ab }, function(a) { return a.reset() });

    function Ab() { this.next = this.g = this.h = null }
    Ab.prototype.set = function(a, b) {
        this.h = a;
        this.g = b;
        this.next = null
    };
    Ab.prototype.reset = function() { this.next = this.g = this.h = null };
    ...
    function Db() {
        if (y.Promise && y.Promise.resolve) {
            ...
            Cb = function() { a.then(Fb) }
        } else Cb = function() { var b = Fb; "function" !== typeof y.setImmediate || y.Window && y.Window.prototype && !M("Edge") && y.Window.prototype.setImmediate == y.setImmediate ? (tb || (tb = ub()), tb(b)) : y.setImmediate(b) }
    }
    var Eb = !1,
        zb = new wb;
    ...
    function Fb() {
        for (var a; a = yb();) {
            try { a.h.call(a.g) } catch (b) { vb(b) }
            sb(xb, a)
        }
        Eb = !1
    };

    function Gb(a) { if (!a) return !1; try { return !!a.$goog_Thenable } catch (b) { return !1 } };
    ...
    var Ib = new rb(function() { return new Hb }, function(a) { a.reset() });
    ...
    N.prototype.then = function(a, b, c) { return Kb(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c) };
    N.prototype.$goog_Thenable = !0;
    N.prototype.cancel = function(a) {
        if (0 == this.g) {
            var b = new P(a);
            Bb(function() { Lb(this, b) }, this)
        }
    };
        ...
        if (0 == a.g) {
            ...
            a: {
                var d = c,
                    e = a.F,
                    g = a.G;
                if (d instanceof N) { Ob(d, Jb(e || A, g || null, a)); var f = !0 } else if (Gb(d)) d.then(e, g, a),
                f = !0;
                else {
                    if (xa(d)) try {
                        var h = d.then;
    ...
    function Pb(a) { a.o || (a.o = !0, Bb(a.v, a)) }
    ...
    function Nb(a, b, c, d) {
        ...
        else try { b.m ? b.l.call(b.i) : Sb(b, c, d) } catch (e) { Tb.call(null, e) }
        sb(Ib, b)
    }

    function Sb(a, b, c) { 2 == b ? a.l.call(a.i, c) : a.h && a.h.call(a.i, c) }

    function Rb(a, b) {
        a.m = !0;
        Bb(function() { a.m && Tb.call(null, b) })
    }
    var Tb = vb;
    ...
    Q.prototype.then = function(a, b, c) {
        ...
        Yb(this, e, function(f) { f instanceof Ub ? g.cancel() : d(f) });
        return g.then(a, b, c)
    };
    Q.prototype.$goog_Thenable = !0;

    function Zb(a) { return Ga(a.m, function(b) { return "function" === typeof b[1] }) }
    ...
    ac.prototype.i = function() { delete $b[this.g]; throw this.h; };
    var $b = {};
    var cc, dc = [];
    ...
    function fc(a, b) {
        ...
        e.onload = e.onreadystatechange = function() { e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (hc(e, c.ra || !1, h), Vb(f), R(f, !0, null)) };
        e.onerror = function() {
            hc(e, !0, h);
    ...
    function nc(a) { return Ra(a.format, a.R, a.na || {}) }

    function lc(a, b, c) {
        c = c || {};
        a = Ra(a, b, c);
        var d = kc(a, { timeout: 3E4, attributes: { async: !1, defer: !1 } });
        return new Promise(function(e) { Yb(d, e, null, void 0) })
    }
    I.j.A.Ia = function(a) { lc = a };
    I.j.A.La = function(a) { kc = a };
    I.j.A.ha = nc;
    I.j.A.load = mc;
    I.j.A.Aa = function(a) {
        a = Fa(a, nc);
        ...
        var b = { timeout: 3E4, attributes: { async: !1, defer: !1 } },
            c = [];
        !db || nb() ? Ea(a, function(d) { c.push(kc(d, b)) }) : c.push(ec(a, b));
        return Promise.all(Fa(c, function(d) { return new Promise(function(e) { return Yb(d, e, null, void 0) }) }))
    };
    I.j.A.Ca = function(a, b, c) { return { format: a, R: b, na: c } };
    I.j.D = {};
    var S = {};
    I.j.D.va = function(a) { return S[a] && S[a].loaded };
    I.j.D.wa = function(a) { return S[a] && S[a].promise };
    I.j.D.la = function() {
    ...
    I.j.D.Ka = function(a, b) { S[a] = { promise: b, loaded: !1 } };
    I.j.N = {};
    I.j.N.P = { 1: "1.0", "1.0": "current", "1.1": "upcoming", "1.2": "testing", 41: "pre-45", 42: "pre-45", 43: "pre-45", 44: "pre-45", 46: "46.1", "46.1": "46.2", 48: "48.1", current: "50", upcoming: "50", testing: "50" };
    ...
    l = oc.prototype;
    l.I = function() { pc(this); for (var a = [], b = 0; b < this.g.length; b++) a.push(this.h[this.g[b]]); return a };
    l.H = function() { pc(this); return this.g.concat() };
    ...
    l.get = function(a, b) { return T(this.h, a) ? this.h[a] : b };
    l.set = function(a, b) {
    ...
    function vc(a, b, c) { b instanceof U ? (a.i = b, Dc(a.i, a.m)) : (c || (b = yc(b, Ec)), a.i = new U(b, a.m)) }

    function xc(a, b) { return a ? b ? decodeURI(a.replace(/%25/g, "%2525")) : decodeURIComponent(a) : "" }

    function yc(a, b, c) { return "string" === typeof a ? (a = encodeURI(a).replace(b, Fc), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null }

    function Fc(a) { a = a.charCodeAt(0); return "%" + (a >> 4 & 15).toString(16) + (a & 15).toString(16) }
    var zc = /[#\/\?@]/g,
        Bc = /[#\?:]/g,
        Ac = /[#\?]/g,
        Ec = /[#\?@]/g,
    ...
    function V(a) { a.g || (a.g = new oc, a.h = 0, a.i && rc(a.i, function(b, c) { a.add(decodeURIComponent(b.replace(/\+/g, " ")), c) })) }
    l = U.prototype;
    l.add = function(a, b) {
        V(this);
        this.i = null;
    ...
    l.forEach = function(a, b) {
        V(this);
        this.g.forEach(function(c, d) { Ea(c, function(e) { a.call(b, e, d, this) }, this) }, this)
    };
    l.H = function() {
        V(this);
    ...
    l.I = function(a) {
        ...
        else { a = this.g.I(); for (var c = 0; c < a.length; c++) b = Ha(b, a[c]) }
        return b
    };
    l.set = function(a, b) {
        V(this);
    ...
    function Tc(a) { a = a || ""; "" !== X && X !== a && (console.warn(" Attempting to load version '" + a + "' of Google Charts, but the previously loaded '" + (X + "' will be used instead.")), a = X); return X = a || "" }

    function Uc(a) { a = a || ""; "" !== Y && Y !== a && (console.warn(" Attempting to load Google Charts for language '" + a + "', but the previously loaded '" + (Y + "' will be used instead.")), a = Y); "en" === a && (a = ""); return Y = a || "" }
    ...
    function Wc(a, b) {
        ...
        return Z = Ic.then(function() { return Jc(b) })
    }
    I.pa = function(a) { return I.load(Object.assign({}, a, { safeMode: !0 })) };
    ...
    I.X = function(a) { if (!Z) throw Error("Must call google.charts.load before google.charts.setOnLoadCallback"); return a ? Z.then(a) : Z };
