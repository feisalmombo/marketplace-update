(function() {
    ...
    f.AmRectangularChart = f.Class({
        ...
        zoomOut: function() { this.zoomOutValueAxes() },
        ...
        zoomOutValueAxes: function() { for (var a = this.valueAxes, b = 0; b < a.length; b++) a[b].zoomOut() },
...
(function() {
    ...
    f.AmSerialChart = f.Class({
            ...
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                if (f.ifArray(a)) {
                    ...
                    var b = a.length - 1,
                        c, d;
                    c = this.categoryAxis;
                    if (c.parseDates && !c.equalSpacing) { if (c = this.startTime, d = this.endTime, isNaN(c) || isNaN(d)) c = this.firstTime, d = this.lastTime } else {
                        c = this.start;
                        d = this.end;
        ...
        cleanChart: function() { f.callMethod("destroy", [this.valueAxes, this.graphs, this.categoryAxis, this.chartScrollbar, this.chartCursor, this.valueScrollbar]) },
        ...
        getStartTime: function(a) {
            ...
            return f.resetDateToMin(new Date(a), b.minPeriod,
                1, b.firstDayOfWeek).getTime()
        },
        getEndTime: function(a) { var b = f.extractPeriod(this.categoryAxis.minPeriod); return f.changeDate(new Date(a), b.period, b.count, !0).getTime() - 1 },
        updateMargins: function() {
        ...
        updateColumnsDepth: function() {
            if (0 !== this.depth3D || 0 !== this.angle) {
                var a, b = this.graphs,
                    c;
                this.columnsArray = [];
                for (a = 0; a < b.length; a++) { c = b[a]; var d = c.columnsArray; if (d) { var g; for (g = 0; g < d.length; g++) this.columnsArray.push(d[g]) } }
        ...
        compareDepth: function(a, b) { return a.depth > b.depth ? 1 : -1 },
        ...
        countColumns: function() {
            ...
            for (l = 0; l < b; l++) {
                ...
                if ("none" == k || "3d" == k) {
                    f = !1;
                    for (e = 0; e < c; e++) d = this.graphs[e], d.valueAxis == g && "column" == d.type && (d.clustered ? (d.tcc = 1, d.newStack && (a = 0), d.hidden || (d.columnIndex = a, a++)) :
        ...
        updateLegendValues: function() { this.legend && this.legend.updateValues() },
        ...
        zoomToCategoryValues: function(a, b) { this.chartData && this.zoom(this.getCategoryIndexByValue(a), this.getCategoryIndexByValue(b)) },
        formatPeriodString: function(a, b) {
            if (b) {
                ...
                for (var l = 0; l < c.length; l++) {
                    for (var k = c[l], m = 0, p =
                            0, n = 0, u = 0, v, x, E, t, r, B, q, w, y, C, F = this.start; F <= this.end; F++) {
                        var D = h[F];
                        if (D) {
                            ...
                            if (A) {
                                if (A.values) {
                                    var z = A.values[k],
                                        D = D.x.categoryAxis;
                                    if (this.rotate) { if (0 > D || D > A.graph.height) z = NaN } else if (0 > D || D > A.graph.width) z = NaN;
                                    if (!isNaN(z)) {
                                        isNaN(v) && (v = z);
                                        x = z;
                                        if (isNaN(E) || E > z) E = z;
        ...
        formatString: function(a, b, c) {
            if (b) {
                ...
                if (void 0 !==
                    ...
                    g || (g = this.nf);
                    h = b.graph.valueAxis;
                    (e = h.duration) && !isNaN(b.values.value) && (e = f.formatDuration(b.values.value, e, "", h.durationUnits,
                        h.maxInterval, g), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), e));
        ...
        updateChartCursor: function() {
            ...
            if (a) {
                ...
                b && (b.balloonTextFunction = a.categoryBalloonFunction,
                    a.categoryLineAxis = b, b.balloonText = a.categoryBalloonText, a.categoryBalloonEnabled && ((e = b.balloon) || (e = {}), e = f.extend(e, this.balloon, !0), e.fillColor = d, e.balloonColor = d, e.fillAlpha = c, e.borderColor = d, e.color = g, b.balloon = e), b.balloon && (b.balloon.enabled = a.categoryBalloonEnabled))
            }
        },
        addChartScrollbar: function(a) {
            f.callMethod("destroy", [this.chartScrollbar]);
            a && (a.chart = this, this.listenTo(a, "zoomed", this.handleScrollbarZoom));
            this.rotate ? void 0 === a.width && (a.width = a.scrollbarHeight) : void 0 === a.height &&
        ...
        update: function() {
            ...
            this.valueScrollbar && this.valueScrollbar.update &&
        ...
        handleValueAxisZoom: function(a) { this.handleValueAxisZoomReal(a, this.valueAxes) },
        zoomOut: function() {
        ...
        handleCursorZoomReal: function(a, b, c, d, g) {
            ...
            isNaN(e) || isNaN(l) || (a = this.categoryAxis, a.parseDates && !a.equalSpacing ? this.zoomToDates(new Date(e),
                new Date(l)) : this.zoomToIndexes(e, l))
        },
        ...
        handleCursorMove: function(a) {
            f.AmSerialChart.base.handleCursorMove.call(this,
                a);
            var b = a.target,
                c = this.categoryAxis;
                    ...
                    if (g = this.chartData[g]) {
                        ...
                        if (this.prevCursorItem != g || k != this.prevMostCloseGraph) {
                            ...
                            for (h = 0; h < d.length; h++) {
                                ...
                                l = e.valueAxis.id;
                                l = g.axes[l].graphs[e.id];
                                if (b.showNextAvailable && isNaN(l.y) && (l = this.getNextItem(l), !l && e.balloon)) { e.balloon.hide(); continue }
                                k && e != k ? (e.showGraphBalloon(l, b.pointer, !1, b.graphBulletSize, b.graphBulletAlpha), e.balloon.hide(0)) : b.valueBalloonsEnabled ?
                                    (e.balloon.showBullet = b.bulletsEnabled, e.balloon.bulletSize = b.bulletSize / 2, a.hideBalloons || (e.showGraphBalloon(l, b.pointer, !1, b.graphBulletSize, b.graphBulletAlpha), e.balloon.set && m.push({ balloon: e.balloon, y: e.balloon.pointToY }))) : (e.currentDataItem = l, e.resizeBullet(l, b.graphBulletSize, b.graphBulletAlpha))
                            }
        ...
        handleCursorHide: function(a) {
            f.AmSerialChart.base.handleCursorHide.call(this,
                a);
            a = this.categoryAxis;
            this.prevCursorItem = null;
            this.updateLegendValues();
        ...
        handleCursorPanning: function(a) {
            ...
            if (b.zoomable && (0 < Math.abs(d) || 0 < Math.abs(h)))
                ...
                } else if (e = this.start0, g = this.end0, c = g - e, d = Math.round(c * d), h = Math.round(c * h), k = this.chartData.length - 1, a || (c = 0), a = f.fitToBounds(e - d, 0, k - c), c = f.fitToBounds(g - h, c, k), this.start != a || this.end != c) this.skipZoomed = !0, b.fire({ chart: this, target: b, type: "zoomed", start: a, end: c }), this.zoom(a, c), n = !0;
        ...
        arrangeBalloons: function(a) {
            ...
            var c, d, f, h = this.plotAreaWidth,
                e = a.length;
            for (c =
                0; c < e; c++) d = a[c].balloon, d.setBounds(0, 0, h, b), d.restorePrevious(), d.draw(), b = d.yPos - 3;
            a.reverse();
            for (c = 0; c < e; c++) {
                d = a[c].balloon;
                var b = d.bottom,
...
(function() {
    ...
    f.Cuboid = f.Class({
        ...
        draw: function() {
            ...
            1 > Math.abs(g) && (g = 0);
            1 > Math.abs(d) && (d = 0);
            !isNaN(t) && (0 < Math.abs(h) || 0 < Math.abs(e)) ? (l = [B], l = { fill: l, stroke: p, "stroke-width": m, "stroke-opacity": n, "fill-opacity": k }, K ? (k = "M0,0 L" + d + "," + (g / 2 - g / 2 * t), m = " B", 0 < d && (m = " A"), f.VML ? (k += m + Math.round(d -
        ...
        animateHeight: function(a, b) {
            ...
            c.frame = 0;
            c.height(1);
            setTimeout(function() { c.updateHeight.call(c) }, 1E3 / f.updateRate)
        },
        updateHeight: function() {
            var a = this;
            a.frame++;
            var b = a.totalFrames;
            a.frame <= b ? (b = a.easing(0, a.frame, 1, a.rh - 1, b), a.height(b), window.requestAnimationFrame ? window.requestAnimationFrame(function() { a.updateHeight.call(a) }) : setTimeout(function() { a.updateHeight.call(a) }, 1E3 / f.updateRate)) : (a.height(a.rh), a.animationFinished = !0)
        },
        animateWidth: function(a, b) {
            ...
            c.frame = 0;
            c.width(1);
            setTimeout(function() { c.updateWidth.call(c) }, 1E3 / f.updateRate)
        },
        updateWidth: function() {
            var a = this;
            a.frame++;
            var b = a.totalFrames;
            a.frame <= b ? (b = a.easing(0, a.frame, 1, a.rw - 1, b), a.width(b), window.requestAnimationFrame ? window.requestAnimationFrame(function() { a.updateWidth.call(a) }) : setTimeout(function() { a.updateWidth.call(a) }, 1E3 / f.updateRate)) : (a.width(a.rw), a.animationFinished = !0)
        }
    })
})();
(function() {
    ...
    f.CategoryAxis = f.Class({
            ...
            if (f.ifArray(a)) {
                ...
                for (b = 0; b < y; b++)
                    if (k = this.guides[b], q = q = q = r = d = NaN, m = k.above, k.toCategory && (q = c.getCategoryIndexByValue(k.toCategory), isNaN(q) || (d = this.getCoordinate(q - h), k.expand &&
                        ...
                        q = !1;
                        if (this.rotate) { if (d < this.height || r < this.height) q = !0 } else if (d < this.width || r < this.width) q = !0;
        ...
        xToIndex: function(a) {
            ...
            if (this.parseDates && !this.equalSpacing) a =
                this.startTime + Math.round(a / g) - this.minDuration() / 2, h = c.getClosestIndex(b, "time", a, !1, this.start, this.end + 1);
        ...
        coordinateToValue: function(a) { a = this.xToIndex(a); if (a = this.data[a]) return this.parseDates ? a.time : a.category },
