...
<body style="font-family: 'Montserrat', sans-serif">
    ...
    <div style="text-align: center;font-family: 'Montserrat', sans-serif">
        <img class="img-responsive" src="../public/temp/images/logo.png" alt="MarketPlace Logo" width="300" >
        <br>

		<div class="text-center" style="text-align: center;font-family: 'Montserrat', sans-serif">
